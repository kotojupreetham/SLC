...
export function ContactNode() {
  ...
  return (
    <section className="py-24 px-6 max-w-4xl mx-auto border-t border-[rgba(255,255,255,0.08)] chapter-confidence">
      <ScrollReveal
        direction="up"
        className="bg-[#0f172a] border border-[rgba(56,189,248,0.3)] rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden backdrop-blur-xl"
        as="div"
      >
        ...
        {!submitted ? (
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              ...
              disabled={isSubmitting}
              data-cursor="cta"
              className="w-full py-4 rounded-xl bg-gradient-to-r from-[#38bdf8] via-[#60a5fa] to-[#818cf8] text-[#090d16] font-mono font-bold text-sm tracking-wider uppercase hover:opacity-95 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 shadow-[0_0_25px_rgba(56,189,248,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#38bdf8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#090d16] disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer"
            >
              {isSubmitting ? (
                <>
