    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          {SERVICES.map((service) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "p-5 rounded-2xl border text-left transition-all duration-300 flex items-center justify-between relative overflow-hidden",
                  ...
                  isSelected
                    ...
                    : "bg-[#030712]/80 border-[rgba(255,255,255,0.08)] hover:border-[#334155] hover:bg-[#0f172a]/60"
                )}
              >
        ...
        <div className="lg:col-span-7 glass-panel rounded-3xl p-8 md:p-10 flex flex-col justify-between relative overflow-hidden border border-[rgba(255,255,255,0.1)] shadow-2xl">
          <div className="relative z-10 key-transition">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {active.metrics.map((metric, i) => (
                <div
                  key={i}
                  className="p-4 rounded-2xl bg-[#030712]/70 border border-[rgba(255,255,255,0.08)] shadow-inner transition-all hover:border-[#38bdf8]/30"
                >
          ...
          <div className="relative z-10 pt-4 border-t border-[rgba(255,255,255,0.08)]">
            ...
            <div className="flex flex-wrap gap-2">
              {active.tags.map((tag, i) => (
                <span
                  key={i}
                  className="px-3.5 py-1.5 rounded-xl bg-[#1e293b]/80 border border-[#334155] text-xs font-mono text-[#cbd5e1] shadow-sm hover:border-[#38bdf8]/50 hover:text-white transition-all duration-200"
                >
                  {tag}
                </span>
              ))}
